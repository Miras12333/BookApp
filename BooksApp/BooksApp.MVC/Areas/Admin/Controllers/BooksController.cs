    ...
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create(BookAddViewModel bookAddViewModel)
        {
            if (ModelState.IsValid)
            {
                ...
                TempData["Message"] = Jobs.CreateMessage("Успешно", "Книга успешно сохранена.", "success");
            ...
            TempData["Message"] = Jobs.CreateMessage("Ошибка!", "Произошла ошибка при сохранении, пожалуйста, проверьте и повторите попытку!", "warning");
            return View(bookAddViewModel);
        }
        ...
        public async Task<IActionResult> Delete(BookViewModel bookViewModel)
        {
            ...
            TempData["Message"] = Jobs.CreateMessage("Успешно!", $"{deletedBook.Name} книга успешно удалена!", "success");
            return RedirectToAction("Index");
        }
        #endregion
        #region Onaylı

...
namespace BooksApp.MVC.Areas.Admin.Controllers
{
    ...
    public class RolesController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    TempData["Message"] = Jobs.CreateMessage(
                        "Успешно!",
                        "Информация о роли успешно создана.",
                        "success");
                    // Попробуйте использовать библиотеку js под названием toastr для таких уведомлений. Постарайтесь ее использовать.
                }
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            var members = new List<User>();// Пользователи, принадлежащие данной роли
            var nonMembers = new List<User>();// Пользователи, не принадлежащие данной роли
